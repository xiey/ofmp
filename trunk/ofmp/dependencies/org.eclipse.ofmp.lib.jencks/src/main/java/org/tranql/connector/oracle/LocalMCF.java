...
/**
 * ManagedConnectionFactory for connecting to a Oracle database with local (non-XA) transactions.
 *
...
public class LocalMCF extends AbstractLocalDataSourceMCF {
    ...
    /**
     * Default constructor for an Oracle Local DataSource.
     *
     * @throws SQLException if there was a problem instantiating an OracleDataSource
     */
    public LocalMCF() throws SQLException {
        super(new OracleDataSource(), new OracleExceptionSorter(), true);
        ds = (OracleDataSource) super.dataSource;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LocalMCF) {
            OracleDataSource other = ((LocalMCF) obj).ds;
